...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Dumpstercoin.lnk";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("Dumpstercoin-Qt") + " " + tr("version") + " " +
    ...
    setWindowTitle(tr("Dumpstercoin-Qt"));
